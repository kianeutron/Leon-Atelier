      ...
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mt-3 text-brown/70 max-w-xs">
              Classic-modern menswear in warm neutrals. Tailored layers that work every day.
            </p>
            <div className="mt-4 text-sm text-brown/60">
              Join the newsletter →{' '}
              <a className="underline hover:text-brownDark" href="#">
                Subscribe
              </a>
            </div>
          </div>
          {cols.map((c) => (
            <div key={c.title}>
              ...
              <ul className="space-y-2 text-brown/70">
                {c.links.map((l) => (
                  <li key={l.label}>
                    <a className="hover:text-brownDark" href={l.href}>
                      {l.label}
                    </a>
                  </li>
                ))}
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-sm text-brown/60">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="hover:text-brownDark">
              Privacy
            </a>

...
const cards = [
  { title: 'Coats', subtitle: 'Warm layers', href: '/products?category=coats', bg: 'https://shop.mango.com/assets/rcs/pics/static/T1/fotos/S/17095967_35.jpg?imwidth=2048&imdensity=1&ts=1753783481626' },
  { title: 'Trousers', subtitle: 'Tailored fits', href: '/products?category=trousers', bg: 'https://shop.mango.com/assets/rcs/pics/static/T1/fotos/S/17068266_32.jpg?imwidth=2048&imdensity=1&ts=1760528120828' },
  { title: 'Suits', subtitle: 'Sharp silhouettes', href: '/products?category=suits', bg: 'https://shop.mango.com/assets/rcs/pics/static/T1/fotos_alt/S/17095997_56_01_O1.jpg?imwidth=2048&imdensity=1&ts=1755013229000' },
  { title: 'Essentials', subtitle: 'Everyday staples', href: '/products?category=essentials', bg: 'https://shop.mango.com/assets/rcs/pics/static/T1/fotos/S/17045150_07_D3.jpg?imwidth=2048&imdensity=1&ts=1757520301545' },
]
...
export default function CollectionsPage() {
  return (
    <div className="relative">
      {/* backdrop */}
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(1400px_420px_at_10%_-10%,rgba(201,111,85,0.08),transparent),radial-gradient(1200px_360px_at_100%_120%,rgba(199,161,122,0.10),transparent)]" />
      ...
      <section className="mx-auto max-w-6xl px-4 pt-10 md:pt-14">
        <div className="flex items-end justify-between gap-3 flex-wrap">
          ...
          <Link href="/products" className="inline-flex items-center gap-2 rounded-full border border-sand bg-cream px-4 py-2 text-brown hover:bg-brown hover:text-cream transition">
            View all
      ...
      <section className="px-0 -mt-2 md:-mt-3">
        <div className="relative mx-auto max-w-7xl px-4">
          <div className="flex justify-center">
            <CollectionCard c={cards[3]} className="w-full max-w-3xl md:max-w-4xl lg:max-w-5xl aspect-[21/10] md:aspect-[21/9] lg:aspect-[21/8] overflow-hidden" big />
          </div>
        </div>
      </section>
...
function CollectionCard({ c, className = '', big = false }: { c: { title: string, subtitle: string, href: string, bg: string }, className?: string, big?: boolean }) {
  return (
    <Link href={c.href} aria-label={`Shop ${c.title}`} className={`group block focus:outline-none focus-visible:ring-2 focus-visible:ring-gold/60 rounded-2xl ${className}`}>
      <motion.div

...
export default function AboutPage() {
  return (
    <div className="relative">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(1200px_360px_at_10%_-10%,rgba(201,111,85,0.06),transparent),radial-gradient(1000px_320px_at_100%_120%,rgba(199,161,122,0.08),transparent)]"
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.1fr_1fr] gap-8 md:gap-10 items-center">
            <div>
              ...
              <p className="mt-4 text-brown/80 max-w-prose">
                Léon Atelier was founded on a simple premise: timeless design, honest materials, and
                modern comfort. We craft clothing to live in—pieces that age with grace, travel
                well, and feel considered in every detail.
              </p>
              <div className="mt-6 flex flex-wrap gap-2 text-xs">
                <span className="inline-flex items-center gap-2 rounded-full border border-sand bg-cream px-3 py-1 text-brown/80">
                  Family-owned
                </span>
                <span className="inline-flex items-center gap-2 rounded-full border border-sand bg-cream px-3 py-1 text-brown/80">
                  Small batch
            ...
            <div>
              <div className="relative overflow-hidden rounded-2xl border border-sand bg-cream/60 shadow-sm">
                ...
                <img
                  src="https://shop.mango.com/images/sustainability/11.jpg?imdensity=1&im=RegionOfInterestCrop,width=2048,height=1138,regionOfInterest=(2208,1650)"
                  alt="Atelier"
      ...
      <section className="mx-auto max-w-6xl px-4 pt-0 pb-0 md:pt-2 md:pb-2">
        <div className="mb-0 md:mb-2">
          ...
          <p className="mt-1 md:mt-2 text-brown/70 max-w-prose">
            Design that lasts. Materials with character. And a fit that simply feels right.
          </p>
        </div>
        <ScrollStagger>
            ...
            {[
              {
                year: '2018',
                title: 'First capsule',
                text: 'We launched with five essential pieces built for daily rotation.',
              },
              {
                year: '2020',
                title: 'New atelier',
                text: 'Our workshop expanded to support small-batch tailoring.',
              },
              {
                year: '2023',
                title: 'Carbon offset',
                text: 'We began offsetting our operations with verified climate projects.',
              },
            ].map((t, i) => (
              <motion.div
                key={i}
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        <ScrollReveal>
          <div className="mb-6 md:mb-8">
            ...
            <p className="mt-2 text-brown/70 max-w-prose">
              Tailored construction, hand-finished details, and fabrics chosen for their character
              and longevity.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 lg:gap-7">
            {[
              'https://shop.mango.com/images/sustainability/10.jpg?imdensity=1&im=RegionOfInterestCrop,width=2048,height=1138,regionOfInterest=(1200,805)',
              'https://shop.mango.com/images/sustainability/3.jpg?imdensity=1&im=RegionOfInterestCrop,width=1024,height=1179,regionOfInterest=(892,1200)',
              'https://shop.mango.com/images/sustainability/1.jpg?imdensity=1&im=RegionOfInterestCrop,width=2048,height=1138,regionOfInterest=(0,1560)',
            ].map((src, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 10 }}
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16">
        <ScrollReveal>
          <div className="rounded-2xl border border-sand bg-cream/70 p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-sm">
            <div>
              <h3 className="font-display text-2xl md:text-3xl text-brownDark">
                Designed to live with you
              </h3>
              <p className="mt-2 text-brown/70 max-w-prose">
                Explore the collection and find your next daily staple.
              </p>
            </div>
            <a
              href="/products"

    ...
    <div className="min-h-[80vh] grid place-items-center px-4 py-12 bg-cream">
      <div className="w-full max-w-lg rounded-xl border border-sand bg-cream/90 shadow-soft p-6">
        ...
        <p className="text-sm text-brown/70 mb-6">
          Join Léon Atelier to save favorites and enjoy faster checkout.
        </p>
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 text-sm text-brown/70 hover:text-brownDark"
              >
                {showPwd ? 'Hide' : 'Show'}
              </button>
              <div className="mt-1 h-1 rounded bg-sand/60 overflow-hidden">
                <div
                  className={`${password.length >= 10 ? 'bg-emerald-600' : password.length >= 6 ? 'bg-amber-600' : 'bg-red-600'}`}
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex-1 bg-brown text-cream px-4 py-2 rounded-md hover:opacity-95 disabled:opacity-60"
            >
            ...
            <button
              ...
              className="px-4 py-2 border border-brown text-brown rounded-md hover:bg-sand/60 disabled:opacity-60"
            >
              Sign in
            </button>
          </div>
